...
class Scan:
    def __init__(self):
        self.sem = threading.Semaphore(100)  # 限制线程的最大数量为100个
        self.res=[]     #标记表格计数
    ...
    def server_scan(self,ip):
        ...
        with self.sem:
            try: #masscan扫描
                ...
                mas.scan(ip,ports='1-65535',arguments='--max-rate 1000')#masscan发包率设置为1000
